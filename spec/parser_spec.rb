...
describe HttpParser::Parser, '#initialize' do
  ...
  describe 'callbacks' do
    ...
    describe 'on_url' do
      ...
      subject do
        described_class.new do |parser|
          parser.on_url { |_inst, data| @url = data }
        end
      end
    ...
    describe 'on_header_field' do
      ...
      subject do
        described_class.new do |parser|
          parser.on_header_field { |_inst, data| @header_field = data }
        end
      end
    ...
    describe 'on_header_value' do
      ...
      subject do
        described_class.new do |parser|
          parser.on_header_value { |_inst, data| @header_value = data }
        end
      end
      ...
      context 'when #stop! is called' do
        subject do
          described_class.new do |parser|
            ...
            parser.on_body { |_inst, data| @body = data }
          end
        end
